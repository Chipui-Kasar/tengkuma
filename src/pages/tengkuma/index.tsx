  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Let's work together to achieve your goals! I offer a variety of services, including web design, development, and online shopping. Shop from flipkart, myntra or amazon and send me the link and get the item at discount price. Iwui Tengkuma"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta
          name="keywords"
          content="Iwui Tengkuma, online shopping, amazon, flipkart, Chipui Kasar, Chipui, Iwui Tengkuma Chipui, Latest technology, Sharepoint, Artificial Intelligence, SharePoint Online, Reactjs, Nextjs, How to,"
        />
